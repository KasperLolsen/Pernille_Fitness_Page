        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              <span className="text-primary">{t('liftapp.title')}</span> {t('liftapp.title.suffix')}
            </h2>
            <p className="text-base text-primary font-medium mb-4">{t('liftapp.subtitle')}</p>
            <p className="text-lg text-gray-700 mb-6">
              {t('liftapp.description')}
            </p>
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">{t('liftapp.feature1')}</span>
              </li>
              <li className="flex items-start">
                <div className="bg-primary rounded-full p-1 mr-3 mt-1">
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-gray-700">{t('liftapp.feature2')}</span>
              </li>
              <li className="flex items-start">
                <div className="bg-primary rounded-full p-1 mr-3 mt-1">
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-gray-700">{t('liftapp.feature3')}</span>
              </li>
              <li className="flex items-start">
                <div className="bg-primary rounded-full p-1 mr-3 mt-1">
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-gray-700">{t('liftapp.feature4')}</span>
              </li>
              <li className="flex items-start">
                <div className="bg-primary rounded-full p-1 mr-3 mt-1">
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-gray-700">{t('liftapp.feature5')}</span>
              </li>
              <li className="flex items-start">
                <div className="bg-primary rounded-full p-1 mr-3 mt-1">
                  <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-gray-700">{t('liftapp.feature6')}</span>
              </li>
            </ul>
