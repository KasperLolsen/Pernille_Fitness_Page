    ...
    <section id="services" className="section bg-gray-50 py-24 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="text-center mb-16">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-5 tracking-tight">{t('services.title')} <span className="text-primary">{t('services.title.highlight')}</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
          <ServiceCard
            ...
            description={t('services.package.desc')}
            icon={
        ...
        <div className="text-center mt-16">
          ...
          >
            <a href="#contact" className="btn btn-primary text-lg px-8 py-4 hover:shadow-lg hover:translate-y-[-2px] transition-all duration-300">{t('services.cta')}</a>
          </motion.div>
        </div>
      </div>
    </section>
