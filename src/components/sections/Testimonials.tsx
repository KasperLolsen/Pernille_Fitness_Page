...
const Testimonials: React.FC = () => {
  ...
  // Resume autoplay when mouse leaves the testimonials section
  const handleMouseLeave = () => {
    setAutoPlay(true);
  };
  
  // Pause autoplay when mouse enters the testimonials section
          ...
          <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="relative p-8 md:p-12">
              ...
              <div className="mt-4 text-center">
                ...
                >
                  {autoPlay ? 'Pause' : 'Auto-play'} testimonials
                </button>
              </div>
            </div>
          </div>
